  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', background: t.paper, color: t.ink, fontFamily: 'Inter, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{ width: '100%', maxWidth: 1280, position: 'relative' }}>
        <NavBar theme={theme} active="profile" />
            ...
            <div style={{ marginTop: 32 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginTop: 12 }}>
                {[
                  ...
                  const pal = TOKENS.pastels[n.color as keyof typeof TOKENS.pastels];
                  return (
                    <div key={n.name} style={{ background: t.paperAlt, border: `1px solid ${t.rule}`, borderRadius: 3, padding: 14 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <span style={{ width: 28, height: 28, background: pal.bg, borderRadius: 999, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'JetBrains Mono', fontSize: 11, color: pal.text, fontWeight: 600 }}>nb</span>
