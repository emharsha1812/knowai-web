// Course/syllabus page — full curriculum view

function Syllabus({ theme = 'light' }) {
  ...
  return (
    <div style={{ width: 1280, background: t.paper, color: t.ink, fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ padding: '12px 80px 80px' }}>
        {tiers.map((tier) => {
          const pal = TOKENS.pastels[tier.color];
          return (
                  ...
                  <div key={m.n} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      ...
                      <div style={{
                        ...
                        <span style={{ transform: 'scale(0.55)' }}>{Icons[m.icon](pal.text)}</span>
                      </div>
                    </div>
